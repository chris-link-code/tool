	...
	extends JPanel
{
	...
	private void initComponents() {
        ...
        var scrollPaneLabel = new JLabel();
        var scrollPane13 = new JScrollPane();
        var panel1 = new JPanel();
        var scrollBar2 = new JScrollBar();
        var scrollBar3 = new JScrollBar();
        var scrollBar7 = new JScrollBar();
        var scrollBar8 = new JScrollBar();
        ...
        var toggleButton7 = new JToggleButton();
        var panel2 = new JPanel();
        var scrollBarLabel = new JLabel();
        var scrollBar1 = new JScrollBar();
        var scrollBar4 = new JScrollBar();
        var panel3 = new JPanel();
        var label4 = new JLabel();
        var label3 = new JLabel();
        var scrollPane15 = new JScrollPane();
        var editorPane6 = new JEditorPane();
        var scrollPane16 = new JScrollPane();
        var textPane6 = new JTextPane();
        var scrollBar5 = new JScrollBar();
        var scrollBar6 = new JScrollBar();
        var separatorLabel = new JLabel();
        var separator1 = new JSeparator();
        var sliderLabel = new JLabel();
        var slider1 = new JSlider();
        var slider6 = new JSlider();
        slider3 = new JSlider();
        var slider5 = new JSlider();
        var progressBarLabel = new JLabel();
        progressBar1 = new JProgressBar();
        progressBar2 = new JProgressBar();
        indeterminateCheckBox = new JCheckBox();
        var toolTipLabel = new JLabel();
        var toolTip1 = new JToolTip();
        var toolTip2 = new JToolTip();
        var toolBarLabel = new JLabel();
        var toolBar1 = new JToolBar();
        var button4 = new JButton();
        var button6 = new JButton();
        var button7 = new JButton();
        var button8 = new JButton();
        var toggleButton6 = new JToggleButton();
        var button1 = new JButton();
        var splitPaneLabel = new JLabel();
        var splitPane3 = new JSplitPane();
        var splitPane1 = new JSplitPane();
        var panel10 = new JPanel();
        var label1 = new JLabel();
        var panel11 = new JPanel();
        var label2 = new JLabel();
        var splitPane2 = new JSplitPane();
